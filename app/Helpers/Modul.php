...
class Modul
{
    public static function importRsaKey($pem)
    {
    ...
    public static function aesEncrypt($data, $symmetricKey)
    {
    ...
    public static function aesDecrypt($encryptedData, $symmetricKey)
    {
        $cipher = 'aes-256-gcm';
        $ivLength = 12;
        $tagLength = 16;
    ...
    //done php_sec_lib
    public static function encryptMessage($message, $pubPEM)
    {

        // Generate a symmetric key
        $aesKey = self::generateSymmetricKey(); // Generate a 256-bit key (32 bytes)
    ...
    function decryptMessage($message, $privateKey)
    {
        ...
        $decryptedMessage = self::aesDecrypt($encryptedMessage, $aesKey);

        return $decryptedMessage;
    }

    //not need php_sec_lib directly
    public static function generateUrl($agen, $nik_agen, $accessToken, $apiUrl, $environment)
    {
